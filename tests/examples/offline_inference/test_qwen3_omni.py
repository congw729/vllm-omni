...
"""
E2E tests for Qwen3-Omni offline inference examples.

Tests verify that examples/offline_inference/qwen3_omni/end2end.py works correctly
...
# Query types supported by Qwen3-Omni (must match query_map in end2end.py)
QUERY_TYPES = [
    "text",
    "use_audio",
    "use_image",
